...
const ChatWidget = ({ initialMessages = [], placeholder = "Digite sua mensagem...", onSendMessage, position = "left", primaryColor = "hsl(var(--primary))", title = "Assistente Virtual", welcomeMessage = "Olá! Como posso ajudá-lo hoje?", onToggle, defaultOpen = false, className, }) => {
    ...
    return (jsxRuntimeExports.jsx("div", { className: "hello-cli-root", children: jsxRuntimeExports.jsxs("div", { className: "hello-cli-fixed hello-cli-bottom-0 hello-cli-right-0 hello-cli-w-full hello-cli-max-w-[400px]", children: [jsxRuntimeExports.jsx("div", { className: cn("hello-cli-fixed hello-cli-z-50", positionClasses[position]), children: jsxRuntimeExports.jsx(Button, { onClick: handleToggle, size: "lg", className: cn("hello-cli-h-14 hello-cli-w-14 hello-cli-rounded-full hello-cli-shadow-lg hover:hello-cli-shadow-xl hello-cli-transition-all hello-cli-duration-300 hello-cli-ease-in-out hello-cli-flex hello-cli-items-center hello-cli-justify-center", isOpen && "hello-cli-rotate-180"), style: { backgroundColor: primaryColor }, children: isOpen ? (jsxRuntimeExports.jsx(X, { className: "hello-cli-h-6 hello-cli-w-6 hello-cli-transition-transform hello-cli-text-white" })) : (jsxRuntimeExports.jsx(MessageCircle, { className: "hello-cli-h-6 hello-cli-w-6 hello-cli-transition-transform hello-cli-text-white" })) }) }), isOpen && (jsxRuntimeExports.jsx("div", { className: cn("hello-cli-fixed hello-cli-z-50 hello-cli-transition-all hello-cli-duration-300 hello-cli-ease-in-out hello-cli-bg-background", chatPositionClasses[position], "hello-cli-animate-slide-in"), children: jsxRuntimeExports.jsxs(Card, { className: "hello-cli-w-80 hello-cli-h-96 hello-cli-shadow-2xl hello-cli-rounded-lg hello-cli-overflow-hidden hello-cli-flex hello-cli-flex-col", children: [jsxRuntimeExports.jsxs("div", { className: "hello-cli-flex hello-cli-items-center hello-cli-justify-between hello-cli-p-4 hello-cli-border-b hello-cli-rounded-t-lg hello-cli-text-white hello-cli-shrink-0", style: { backgroundColor: primaryColor }, children: [jsxRuntimeExports.jsxs("div", { className: "hello-cli-flex hello-cli-items-center hello-cli-gap-2", children: [jsxRuntimeExports.jsx(Avatar, { className: "hello-cli-h-8 hello-cli-w-8", children: jsxRuntimeExports.jsx(AvatarFallback, { className: "hello-cli-bg-white/20", children: jsxRuntimeExports.jsx(Bot, { className: "hello-cli-h-4 hello-cli-w-4" }) }) }), jsxRuntimeExports.jsx("h3", { className: "hello-cli-font-semibold hello-cli-text-sm", children: title })] }), jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: handleToggle, className: "hello-cli-text-white hover:hello-cli-bg-white/20 hello-cli-h-8 hello-cli-w-8 hello-cli-p-0 hello-cli-flex hello-cli-items-center hello-cli-justify-center", children: jsxRuntimeExports.jsx(X, { className: "hello-cli-h-4 hello-cli-w-4 hello-cli-text-white" }) })] }), jsxRuntimeExports.jsx(ScrollArea, { className: "hello-cli-flex-1 hello-cli-p-4 hello-cli-overflow-y-auto hello-cli-scroll-smooth", children: jsxRuntimeExports.jsxs("div", { className: "hello-cli-space-y-4 hello-cli-pb-4", children: [messages.map((message) => (jsxRuntimeExports.jsxs("div", { className: cn("hello-cli-flex hello-cli-gap-2", message.role === 'user' ? "hello-cli-justify-end" : "hello-cli-justify-start"), children: [message.role === 'bot' && (jsxRuntimeExports.jsx(Avatar, { className: "hello-cli-h-6 hello-cli-w-6 hello-cli-mt-1", children: jsxRuntimeExports.jsx(AvatarFallback, { className: "hello-cli-bg-muted", children: jsxRuntimeExports.jsx(Bot, { className: "hello-cli-h-3 hello-cli-w-3" }) }) })), jsxRuntimeExports.jsx("div", { className: cn("hello-cli-max-w-[70%] hello-cli-rounded-lg hello-cli-px-3 hello-cli-py-2 hello-cli-text-sm", message.role === 'user'
                                                        ? "hello-cli-bg-primary hello-cli-text-primary-foreground"
                                                        : "hello-cli-bg-muted hello-cli-text-muted-foreground"), children: message.content }), message.role === 'user' && (jsxRuntimeExports.jsx(Avatar, { className: "hello-cli-h-6 hello-cli-w-6 hello-cli-mt-1", children: jsxRuntimeExports.jsx(AvatarFallback, { className: "hello-cli-bg-primary", children: jsxRuntimeExports.jsx(User, { className: "hello-cli-h-3 hello-cli-w-3 hello-cli-text-primary-foreground" }) }) }))] }, message.id))), isTyping && (jsxRuntimeExports.jsxs("div", { className: "hello-cli-flex hello-cli-gap-2 hello-cli-justify-start", children: [jsxRuntimeExports.jsx(Avatar, { className: "hello-cli-h-6 hello-cli-w-6 hello-cli-mt-1", children: jsxRuntimeExports.jsx(AvatarFallback, { className: "hello-cli-bg-muted", children: jsxRuntimeExports.jsx(Bot, { className: "hello-cli-h-3 hello-cli-w-3" }) }) }), jsxRuntimeExports.jsx("div", { className: "hello-cli-bg-muted hello-cli-rounded-lg hello-cli-px-3 hello-cli-py-2", children: jsxRuntimeExports.jsxs("div", { className: "hello-cli-flex hello-cli-gap-1", children: [jsxRuntimeExports.jsx("div", { className: "hello-cli-w-2 hello-cli-h-2 hello-cli-bg-muted-foreground hello-cli-rounded-full hello-cli-animate-bounce" }), jsxRuntimeExports.jsx("div", { className: "hello-cli-w-2 hello-cli-h-2 hello-cli-bg-muted-foreground hello-cli-rounded-full hello-cli-animate-bounce", style: { animationDelay: "0.1s" } }), jsxRuntimeExports.jsx("div", { className: "hello-cli-w-2 hello-cli-h-2 hello-cli-bg-muted-foreground hello-cli-rounded-full hello-cli-animate-bounce", style: { animationDelay: "0.2s" } })] }) })] })), jsxRuntimeExports.jsx("div", { ref: messagesEndRef, className: "hello-cli-h-px hello-cli-w-full" })] }) }), jsxRuntimeExports.jsx("div", { className: "hello-cli-p-4 hello-cli-border-t hello-cli-mt-auto hello-cli-bg-background hello-cli-shrink-0", children: jsxRuntimeExports.jsxs("div", { className: "hello-cli-flex hello-cli-gap-2", children: [jsxRuntimeExports.jsx(Input, { ref: inputRef, value: inputValue, onChange: (e) => setInputValue(e.target.value), onKeyPress: handleKeyPress, placeholder: placeholder, className: "hello-cli-flex-1" }), jsxRuntimeExports.jsx(Button, { onClick: handleSendMessage, size: "sm", disabled: !inputValue.trim(), style: { backgroundColor: primaryColor }, className: "hello-cli-px-4 hello-cli-py-2 hello-cli-rounded-full hello-cli-flex hello-cli-items-center hello-cli-justify-center hello-cli-transition-all hover:hello-cli-opacity-90", children: jsxRuntimeExports.jsx(Send, { className: "hello-cli-h-4 hello-cli-w-4 hello-cli-text-white" }) })] }) })] }) }))] }) }));
};
