...
import React__default, { useState, createElement, useRef, useEffect } from 'react';
import { Root, Fallback } from '@radix-ui/react-avatar';
import { clsx } from 'clsx';
import { twMerge } from 'tailwind-merge';
import { Slot } from '@radix-ui/react-slot';
import { cva } from 'class-variance-authority';
import { Root as Root$1, Viewport, Corner, ScrollAreaScrollbar, ScrollAreaThumb } from '@radix-ui/react-scroll-area';
import { X, MessageCircle, Bot, User, Send } from 'lucide-react';
...
function Avatar(_ref) {
  ...
  return createElement(Root, Object.assign({
    "data-slot": "avatar",
...
function AvatarFallback(_ref3) {
  ...
  return createElement(Fallback, Object.assign({
...
function ScrollArea(_ref) {
  ...
  return createElement(Root$1, Object.assign({
    "data-slot": "scroll-area",
    className: cn("relative", className)
  }, props), createElement(Viewport, {
    "data-slot": "scroll-area-viewport",
    className: "focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1"
  }, children), createElement(ScrollBar, null), createElement(Corner, null));
}
function ScrollBar(_ref2) {
  ...
  return createElement(ScrollAreaScrollbar, Object.assign({
  ...
  }, props), createElement(ScrollAreaThumb, {
...
var ChatWidget = function ChatWidget(_ref) {
  ...
  var _useState2 = useState(initialMessages.length > 0 ? initialMessages : [{
      id: "1",
      role: 'bot',
  ...
  }, isOpen ? React__default.createElement(X, {
    className: "h-6 w-6"
  }) : React__default.createElement(MessageCircle, {
    className: "h-6 w-6"
  ...
  }, React__default.createElement(Bot, {
    className: "h-4 w-4"
